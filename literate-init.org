...
Здесь в сущности ссылка на клон конфига из репозитория.
...
Find application name in my/application-name variable."
    (let ((frame-text (concat text " - " my/application-name)))

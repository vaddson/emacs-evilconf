...
#+begin_src emacs-lisp :tangle yes
(my/leader-def nil 'override
    "TAB v" '(my/show-last-perspective :which-key "Show last workspace"))
...
(my/leader-def nil 'override
    ...
    "b b" '(counsel-projectile-switch-to-buffer :which-key "Switch buffer in project")
    ;; "," #'counsel-projectile-switch-to-buffer
...
#+begin_src emacs-lisp :tangle yes
(my/localleader-def nil 'org-mode-map
	"s o" '(my/individual-visibility-source-blocks :which-key "Fold :hidden src-blocks")
	"s O" '(org-hide-block-all :which-key "Fold all stc-blocks except :visual"))
#+end_src

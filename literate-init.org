...
- "notes" - теплая тема,
- "dev"   - холодная тема,
- "rest"  - холодная тема с прозрачностью.
...
(evil-define-key nil 'global
    ...
    (kbd "<leader> n I") #'my/set-title-bar-and-workspace-interactive)
#+end_src
...
(evil-define-key nil 'global
    ...
    (kbd "<leader> o P") #'my/treemacs-find-file-and-select-tree-window)
...
#+begin_src emacs-lisp :tangle yes
  (use-package magit
	  ...
	  (define-key magit-refs-mode-map (kbd "SPC") nil)

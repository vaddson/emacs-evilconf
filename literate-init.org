...
#+begin_src emacs-lisp :tangle yes
(setq my/font-families '((:family "Liberation Mono" :size 9 :size-inc 10)
...
(use-package org-tree-slide
    ...
    (setq org-tree-slide-header t
          org-tree-slide-content-margin-top 3))
#+end_src
...
Живой emacs-lisp. Что-то вроде libe-py-mode для Python.
...
(setq dashboard-banner-logo-title
      (concat "\n\n"
              ...
              (format "Open project                               %s\n"
                      (my/get-function-key 'counsel-projectile-switch-project))

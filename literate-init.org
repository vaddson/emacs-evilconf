...
#+begin_src emacs-lisp :tangle yes
(setq my/font-families '((:family "JetBrains Mono" :size-dec 8 :size 9 :size-inc 13)
                         (:family "Liberation Mono" :size-dec 8 :size 9 :size-inc 13)
                         (:family "Monospace" :size-dec 8 :size 9 :size-inc 13)))
#+end_src

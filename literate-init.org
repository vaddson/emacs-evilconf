...
=Vertico= — современный минималистичный интерфейс завершения.
Более быстрый и активно развивается по сравнению с Ivy.
...
=Marginalia= добавляет аннотации (дополнительную информацию) к кандидатам
в меню завершения. Заменяет =ivy-rich=.
...
- демон "rest"  - тема с "прозрачностью".
...
Рассматриваю Eat, как альтернативу Vterm. Устанавливаем Eat.

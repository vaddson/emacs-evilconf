...
зависимости от ширины экрана выбирает один из двух шрифтов. Поскольку
возможность не угадать размер всегда остается, то предусмотрим
катсомную переменную =my/font-total-scale=, в которой зададим
возможность подкрутить размер шрифта под кривые данные монитора.

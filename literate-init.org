...
(use-package ivy-rich
    ...
    (setq ivy-rich-display-transformers-list
          (list
           ...
           'counsel-recentf
           (plist-get ivy-rich-display-transformers-list 'counsel-recentf)
           'package-install
           (plist-get ivy-rich-display-transformers-list 'package-install)
...
(setq dashboard-banner-logo-title
      (concat "                   Welcome to Emacs!"
              ...
              (format "Open project with workspace in new frame    %s\n"
                      (my/get-function-key 'my/switch-project-with-workspace))
              "\n"

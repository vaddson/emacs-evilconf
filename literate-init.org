...
Поработаем над буфером показа ссылок на открытую карточку.
Исключим повторяющиеся ссылки.
...
(defun my/org-roam--make-template-file (subdirectory-name)
    (let* ((subdirectory-name (string-replace "/" "--" subdirectory-name))
           (template-file-name-expand (concat org-roam-directory
                                              "/templates/"
                                              subdirectory-name ".org"))

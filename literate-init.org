...
#+begin_src emacs-lisp :tangle yes
(defcustom my/deepseek-api-key "your-api-key"
  "Deepseek API key.")
...
(my/gptel--register-backend "DeepSeek"
                            (lambda (backend-name)
                                (gptel-make-deepseek backend-name
                                    :stream t
                                    :key (lambda () my/deepseek-api-key)
    ...
    (let* ((url-request-method "POST")
           (url-request-extra-headers
            `(("Content-Type" . "application/x-www-form-urlencoded")
              ...
              ("RqUID" . ,(org-id-uuid))
              ("Authorization" . ,(concat "Basic " my/gigachat-api-key))))
...
Через customize устанавливаем API ключ GigaChat в переменную
my/gigachat-api-key.

#+begin_src emacs-lisp :tangle yes
(defcustom my/gigachat-api-key "your-api-key"
  "GigaChat API key.")
#+end_src
...
- =my/treesit-select-parent-node= - расширяет выделение до
  родительской ноды.
- =my/treesit-select-to-parent-node-top= - расширяет выделение до
  начала родительской ноды.
- =my/treesit-select-back= - откатывает выделение на предыдущее.

#+begin_src emacs-lisp :tangle yes
(defun my/treesit-select-parent-node ()
    (interactive)
    (my/treesit-saver 'my/treesit--select-parent-node))
...
(defun my/treesit-select-to-parent-node-top ()
    (interactive)
    (my/treesit-saver 'my/treesit--select-to-parent-node-top))
...
(defun my/treesit-select-back ()
    (interactive)
    (my/treesit-saver 'my/treesit--select-back))
